...
const GameScreen: FC = () => {
  ...
  const handleGameOver = () => {
    ...
    if (collectedCandies >= totalCount) {
      ...
      Alert.alert("Tebrikler!", `Seviye ${levelId} başarıyla tamamlandı!`, [
        {
          text: "Tamam",
          onPress: () => {
            router.back();
      ...
      Alert.alert(
        "Oyun Bitti!",
        `Seviye ${levelId} tamamlanamadı. Toplam ${collectedCandies} şeker toplandı.`,
        [
          {
            text: "Tekrar Dene",
            onPress: () => {
  ...
  }, [collectedCandies, firstAnimation, totalCount]);
